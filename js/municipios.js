/* Lista client-side dos 142 municípios de MT (IBGE, estado 51).
   Usada no login: ao selecionar "Gestor municipal", o usuário escolhe o
   município e o campo de usuário é preenchido com a conta daquele
   município (normUsuario) — mesmo critério do backend (MUNICIPIOS_SEED). */
(function (global) {
  var MUNICIPIOS_MT = [
    ...
    "Santo Afonso","Santo Antônio de Leverger","Santo Antônio do Leste","São Félix do Araguaia",
  ...
  function dcNormUsuario(nome) {
    return String(nome || "").normalize("NFD").replace(/[\u0300-\u036f]/g, "")
      .toLowerCase().replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, "");
  }

  global.DC_MUNICIPIOS = MUNICIPIOS_MT;
  global.dcNormUsuario = dcNormUsuario;
})(window);
